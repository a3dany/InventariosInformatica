...
<div class="fieldcontain ${hasErrors(bean: prestamoInstance, field: 'solicitante', 'error')} required">
    ...
    <g:select id="solicitante" name="solicitante.id" from="${ii.Usuario.list()}" optionKey="id" required=""
              value="${prestamoInstance?.solicitante?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: prestamoInstance, field: 'ambienteDondeEstara', 'error')} ">
    ...
    <g:select id="ambienteDondeEstara" name="ambienteDondeEstara.id" from="${ii.Ambiente.list()}" optionKey="id"
              value="${prestamoInstance?.ambienteDondeEstara?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: prestamoInstance, field: 'fechaInicio', 'error')} ">
    ...
    <joda:dateTimePicker name="fechaInicio" value="${prestamoInstance?.fechaInicio}" default="${LocalDateTime.now()}"
...
<div class="fieldcontain ${hasErrors(bean: prestamoInstance, field: 'fechaFin', 'error')} ">
    ...
    <joda:dateTimePicker name="fechaFin" value="${prestamoInstance?.fechaFin}" default="${LocalDateTime.now()}"
                         noSelection="['': '']"></joda:dateTimePicker>
</div>
